...
describe('When logged in', async()=>{
  ...
  describe('And using valid inputs', async()=>{
    beforeEach(async()=>{
      ...
      await page.type('.content input', 'My content goes here.');
    ...
    test('submitting and saving adds blogs to index page', async()=>{
      ...
      expect(content).toEqual('My content goes here.');
    });
  })
